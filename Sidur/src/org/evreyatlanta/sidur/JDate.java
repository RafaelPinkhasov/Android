 ...
 * 
 * @see net.sourceforge.zmanim.hebrewcalendar.JCalendar
 * @see JDateFormatter.sourceforge.zmanim.hebrewcalendar.HebrewDateFormatter
 * @see java.util.Date
...
public class JDate implements Comparable<JDate>, Cloneable {
	 ...
	 * @see JDateFormatter#getFormattedKviah(int)
	 */
	...
	public static int getJewishCalendarElapsedDays(int year) {
		long chalakimSince = getChalakimSinceMoladTohu(year, JDate.TISHREI);
	 ...
	 *            constants such as {@link JDate#TISHREI}.
	...
	/**
	 * Converts the the {@link JDate#NISSAN} based constants used by this class to numeric month starting from
	 * {@link JDate#TISHREI}. This is required for Molad claculations.
	 * 
	 * @param year
	 *            The Jewish year
	 * @param month
	...
	private static int getJewishMonthOfYear(int year, int month) {
		boolean isLeapYear = JDate.isJewishLeapYear(year);
	 ...
	 *            a leap year, 13 will be the expected value for Adar II. Use the constants {@link JDate#NISSAN}
	 *            etc.
	 * @param dayOfMonth
	 ...
	 */
	public JDate getMolad() {
		JDate moladDate = new JDate(getChalakimSinceMoladTohu());
	 ...
	 */
	public JDate(int jewishYear, int jewishMonth, int jewishDayOfMonth) {
	 ...
	 * @see JDateFormatter#format(JDate)
	 */
	public String toString() {
		return new JDateFormatter().format(this);
	}
	 ...
	 * they are equal.
	 */
	public int compareTo(JDate jewishDate) {
	...
	public String getJewishMonthName() {
		switch(jewishMonth) {
			...
			case 10: return "TEVES";
			case 11: return "SHEVAT";
			case 12: return "ADAR";
			case 13: return "ADAR II";
			default: return jewishMonth + "";
		}
	}
