 ...
 * @version 0.0.1
 */
public class JCalendar extends JDate {
	 ...
	 */
	public JCalendar(int jewishYear, int jewishMonth, int jewishDayOfMonth) {
	 ...
	 */
	public JCalendar(int jewishYear, int jewishMonth, int jewishDayOfMonth, boolean inIsrael) {
		super(jewishYear, jewishMonth, jewishDayOfMonth);
	...
	public boolean isCholHamoed() {
		int holidayIndex = getYomTovIndex();
		return holidayIndex == JCalendar.CHOL_HAMOED_PESACH || holidayIndex == JCalendar.CHOL_HAMOED_SUCCOS;
	}
	
	public boolean isCholHamoedPesach() {
		return getYomTovIndex() == JCalendar.CHOL_HAMOED_PESACH;
	}
	
	public boolean isCholHamoedSuccot() {
		return getYomTovIndex() == JCalendar.CHOL_HAMOED_SUCCOS;
	}
	
	public boolean isPurim() {
		int holidayIndex = getYomTovIndex();
		return (holidayIndex == JCalendar.PURIM || holidayIndex == JCalendar.PURIM_KATAN);
	}
	
	public boolean isTalumatar() {
		int month = getJewishMonth();
		int day = getJewishDayOfMonth();
		return ((month == NISSAN && day > 14) || 
				month == IYAR ||
				month == SIVAN ||
				month == TAMMUZ || 
				month == AV || 
				month == ELUL ||
			 (month == TISHREI && day > 21));
	}
	...
	public int isOmer() {
		...
		if (month == NISSAN && day == 16)
			return 1;
		else if (month == NISSAN && day == 17)
			return 2;
		else if (month == NISSAN && day == 18)
			return 3;
		else if (month == NISSAN && day == 19)
			return 4;
		else if (month == NISSAN && day == 20)
			return 5;
		else if (month == NISSAN && day == 21)
			return 6;
		else if (month == NISSAN && day == 22)
			return 7;
		else if (month == NISSAN && day == 23)
			return 8;
		else if (month == NISSAN && day == 24)
			return 9;
		else if (month == NISSAN && day == 25)
			return 10;
		else if (month == NISSAN && day == 26)
			return 11;
		else if (month == NISSAN && day == 27)
			return 12;
		else if (month == NISSAN && day == 28)
			return 13;
		else if (month == NISSAN && day == 29)
			return 14;
		else if (month == NISSAN && day == 30)
			return 15;
		else if (month == IYAR && day == 1)
			return 16;
		else if (month == IYAR && day == 2)
			return 17;
		else if (month == IYAR && day == 3)
			return 18;
		else if (month == IYAR && day == 4)
			return 19;
		else if (month == IYAR && day == 5)
			return 20;
		else if (month == IYAR && day == 6)
			return 21;
		else if (month == IYAR && day == 7)
			return 22;
		else if (month == IYAR && day == 8)
			return 23;
		else if (month == IYAR && day == 9)
			return 24;
		else if (month == IYAR && day == 10)
			return 25;
		else if (month == IYAR && day == 11)
			return 26;
		else if (month == IYAR && day == 12)
			return 27;
		else if (month == IYAR && day == 13)
			return 28;
		else if (month == IYAR && day == 14)
			return 29;
		else if (month == IYAR && day == 15)
			return 30;
		else if (month == IYAR && day == 16)
			return 31;
		else if (month == IYAR && day == 17)
			return 32;
		else if (month == IYAR && day == 18)
			return 33;
		else if (month == IYAR && day == 19)
			return 34;
		else if (month == IYAR && day == 20)
			return 35;
		else if (month == IYAR && day == 21)
			return 36;
		else if (month == IYAR && day == 22)
			return 37;
		else if (month == IYAR && day == 23)
			return 38;
		else if (month == IYAR && day == 24)
			return 39;
		else if (month == IYAR && day == 25)
			return 40;
		else if (month == IYAR && day == 26)
			return 41;
		else if (month == IYAR && day == 27)
			return 42;
		else if (month == IYAR && day == 28)
			return 43;
		else if (month == IYAR && day == 29)
			return 44;
		else if (month == SIVAN && day == 1)
			return 45;
		else if (month == SIVAN && day == 2)
			return 46;
		else if (month == SIVAN && day == 3)
			return 47;
		else if (month == SIVAN && day == 4)
			return 48;
	...
	public boolean isTahanun() {
		...
		switch (getJewishMonth()) {
			...
			case IYAR:
				...
				break;
			case SIVAN:
				if (getJewishDayOfMonth() < 7  || (getJewishDayOfMonth() < 8 && !inIsrael)) {
					return false;
				} 
				break;
		case AV:
		...
		case ADAR:
			if (!isJewishLeapYear()) {
				if (getJewishDayOfMonth() == 14 || getJewishDayOfMonth() == 15) {
					return false;
				}
			} else { // else if a leap year
				if (getJewishDayOfMonth() == 14) {
	...
	public boolean isTshuvaDays() {
		 return (getJewishMonth() == TISHREI && getJewishDayOfMonth() > 2 && getJewishDayOfMonth() < 10);
	}
	 ...
	 * {@link JDateFormatter#formatParsha(JCalendar)}.
	 * 
	...
	public int getParshaIndex() {
		...
		JDate roshHashana = new JDate(getJewishYear(), TISHREI, 1); // set it to Rosh Hashana of this year
	 ...
	 * {@link JDateFormatter#formatDafYomiBavli(Daf)} for the ability to format the daf in Hebrew or transliterated
	 * masechta names.
	 * 
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof JCalendar)) {
			return false;
		}
		JCalendar jewishCalendar = (JCalendar) object;
